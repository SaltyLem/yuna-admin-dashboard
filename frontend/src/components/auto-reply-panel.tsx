    ...
    <div className="mb-4 bg-neutral-900 border border-neutral-800 rounded-lg">
      ...
      {open && (
        <div className="px-4 pb-4 space-y-3">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="w-16 px-2 py-1 bg-neutral-800 border border-neutral-700 rounded text-sm"
                min={5}
              />
          ...
          <div className="text-xs text-neutral-500 font-medium">Virtual Viewers</div>
            ...
            <div className="space-y-1">
              {config.viewers.map((v) => (
                <div key={v.authorChannelId} className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-neutral-600 text-xs font-mono">{v.authorChannelId}</span>
                  <button
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 px-2 py-1.5 bg-neutral-800 border border-neutral-700 rounded text-sm placeholder-neutral-600"
            />
            <select
              value={newLocation}
            ...
            <button
              onClick={addViewer}
              className="px-3 py-1.5 bg-neutral-800 border border-neutral-700 rounded text-sm text-neutral-400 hover:text-white transition"
            >
              Add
            </button>
          </div>
