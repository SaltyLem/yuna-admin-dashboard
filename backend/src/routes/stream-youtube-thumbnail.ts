...
const SWITCH_PROMPT_THEMES = [
  ...
  "pastel kawaii room with sparkles, hearts and stars floating, dreamy pink",
  "digital cyberspace grid background, neon cyan and magenta wireframes",
  "sweet cafe interior, warm lights, dessert display, anime aesthetic",
  "magical girl transformation backdrop, sparkles and ribbons, lavender",
  "vaporwave aesthetic with palm leaves and pastel statues, retro pink",
  "cute pixel art game room, RGB lights, anime monitor setup",
  "galaxy themed bedroom, fairy lights forming constellations, deep purple",
  "soft pastel candy land, marshmallow clouds and rainbow ribbons",
  "anime studio with mic and pop filter, bokeh, soft purple lighting",
  "moe gaming setup, pink mechanical keyboard, RGB ambient, plushies",
  "fantasy crystal cave, glowing crystals in pink and purple, ethereal",
  "neon idol stage with spotlights, sparkly confetti, anime concert vibe",
  "cute teatime aesthetic, macarons and flowers, pastel pink table",
  "soft sailor moon style sky, sparkles and crescent moon, lavender night",
  "virtual desktop full of cute icons, pastel UI, kawaii anime",
  "cozy bookshop with fairy lights, anime soft afternoon glow",
  "dreamy bubble underwater, pearls and shells, pink and aqua",
  "shoujo manga heart background, glitter sparkles and ribbon swirls, pink",
  "hi-tech neon shrine gate, cyberpunk meets traditional japan, purple",
  "floating sky island with rainbow clouds, anime fantasy whimsy",
  "retro 90s anime room with crt tv and posters, warm pink ambient",
  "cute pastel kitchen, baking cookies, soft warm light, kawaii",
  "magical library with glowing books, lavender mist, fantasy anime",
  "virtual concert venue with hologram screens, neon idol lights",
  "soft purple bedroom window, snow falling outside, plushies on bed",
  "fairycore aesthetic, mushrooms and butterflies, pastel green and pink",
  "dreamy pink cloud sky with floating gummy bears, kawaii whimsical",
  "neon arcade interior, soft purple and pink lighting, anime vibe",
];
